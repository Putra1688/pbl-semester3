...
class Database
{
    private $host = 'localhost';  // Replace with your server hostname
    private $port = '1433';       // Default SQL Server port
    private $db = 'pesantren'; // Replace with your database name
    private $user = 'admin'; // Replace with your username
    private $password = 'admin'; // Replace with your password
